...
export const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Performance Optimization ( webpagetest.org, Lighthouse, SiteSpeed.io)',
        level: 'Intermediate',
        icon: FaTachometerAlt,
        color: 'text-red-500',
      },
      {
        name: 'Best Practices (Security & Web Standards from Lighthouse)',
        level: 'Intermediate',
        icon: FaShieldAlt,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        level: 'Familiar(used with AI assistance)',
        icon: MdMotionPhotosOn,
        color: 'text-indigo-500',
      },
      {
        name: 'GSAP (Scroll & Advanced Animations)',
        level: 'Familiar(used with AI assistance)',
